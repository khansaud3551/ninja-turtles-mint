    ...
    <div className="nav">
      <div className="container nav__container">
        <div className="nav__left">
          <NavLink to="/">
            <img className="logo" src="/Assets/Logo-Header.png" alt="" />
          </NavLink>
        </div>
        <div className="nav__right">
          <ul className="nav__menu">
            <li>
              <Link onClick={onScrollAbout} spy={true} smooth={true}>
                About
              </Link>
            </li>
            <li>
              <Link onClick={onScrollRoadmap} spy={true} smooth={true}>
                Roadmap
              </Link>
            </li>
            <li>
              <Link onClick={onScrollTeam} spy={true} smooth={true}>
                Team
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link onClick={onScrollFaqs} spy={true} smooth={true}>
                FAQs
              </Link>
            </li>
          </ul>
      ...
      <div className={style} style={{ backgroundImage: bgImg }}>
        <div>
          ...
          <div className="navbar__items">
            ...
            <p>MINT PROGRESS : 737 / 1,000</p>
            <div className="navPhone__button">
              <ButtonPrimary text="Mint Now" />
            </div>
            <br />
            <br />
            <div className="nav__social__icons">
              <ScIcon
                iconSrc="/Assets/icons/akar-icons_twitter-fill.png"
                link="https://twitter.com/StarlightNFT"
              />
              <ScIcon
                iconSrc="/Assets/icons/InstagramLogo.png"
                link="https://instagram.com/starlightxsociety"
              />
              <ScIcon
                iconSrc="/Assets/icons/akar-icons_discord-fill.png"
                link="https://discord.gg/sxs"
              />
              <ScIcon
                iconSrc="/Assets/icons/my.svg"
                link="https://opensea.io/collection/starlight-society"
              />
            </div>
          </div>
        </div>
